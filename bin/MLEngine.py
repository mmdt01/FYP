...
class MLEngine:
    def __init__(self,data_path='',file_to_load='',subject_id='',sessions=[1, 2],ntimes=10,kfold=2,m_filters=2,window_details={}):
    ...
    def experiment(self):
        ...
        '''for my data'''
        my_data = LoadData.LoadMyData(self.file_to_load, self.data_path)
        ...
        for k in range(self.ntimes):
            ...
            for i in range(self.kfold):
                ...
                print(f'Classes are {y_classes_unique}')
...
class FilterBank:
    ...
    def filter_data(self,eeg_data,window_details={}):
        ...
        if window_details:
            ...
            print(f'Number of samples in the window is {n_samples}')
        ...
        for i, fb in self.filter_coeff.items():
            ...
            if window_details:
                eeg_data_filtered = eeg_data_filtered[:,:,int((0+window_details.get('tmin'))*self.fs):int((0+window_details.get('tmax'))*self.fs)+1]
            print(f'Filtered data shape is {eeg_data_filtered.shape}')
